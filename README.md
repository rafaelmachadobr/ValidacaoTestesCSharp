...
![Métodos Swagger](Images/projeto.png)

## Como Executar os Testes

1. Clone o repositório: `git clone https://github.com/rafaelmachadobr/ValidacaoTestesCSharp.git`

2. Navegue até o diretório do projeto: `cd ValidacaoTestesCSharp`

3. Execute o comando `dotnet test` para executar os testes
